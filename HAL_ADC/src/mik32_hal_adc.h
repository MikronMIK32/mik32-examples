...
/* Sel - Выбор канала */
#define ADC_CHANNEL0        0       /* Канал АЦП0 - PORT_0_13 */
#define ADC_CHANNEL1        1       /* Канал АЦП1 - PORT_0_11 */
#define ADC_CHANNEL2        2       /* Канал АЦП2 - PORT_0_9 */
#define ADC_CHANNEL3        3       /* Канал АЦП3 - PORT_0_7 */
#define ADC_CHANNEL4        4       /* Канал АЦП4 - PORT_0_4 */
#define ADC_CHANNEL5        5       /* Канал АЦП5 - PORT_0_2 */
#define ADC_CHANNEL6        6       /* Канал АЦП6 - PORT_1_7 */
#define ADC_CHANNEL7        7       /* Канал АЦП7 - PORT_1_5 */
...
#define ADC_EXTCLB_REF       0       /* Настраиваемый ОИН */
#define ADC_EXTCLB_AVCC      1       /* Внешний вывод */

/* Вход АЦП */
#define ADC_PORT_AS_FUNC3             0b11    /* Четвертая функция вывода (аналоговый сигнал) */ 
#define ADC_CHANNEL0_PORT_0_13        13      /* Канал АЦП0 - PORT_0_13 */
#define ADC_CHANNEL1_PORT_0_11        11      /* Канал АЦП1 - PORT_0_11 */
#define ADC_CHANNEL2_PORT_0_9         9       /* Канал АЦП2 - PORT_0_9 */
#define ADC_CHANNEL3_PORT_0_7         7       /* Канал АЦП3 - PORT_0_7 */
#define ADC_CHANNEL4_PORT_0_4         4       /* Канал АЦП4 - PORT_0_4 */
#define ADC_CHANNEL5_PORT_0_2         2       /* Канал АЦП5 - PORT_0_2 */
#define ADC_CHANNEL6_PORT_1_7         7       /* Канал АЦП6 - PORT_1_7 */
#define ADC_CHANNEL7_PORT_1_5         5       /* Канал АЦП7 - PORT_1_5 */
